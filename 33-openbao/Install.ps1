...
# Set-OpenBaoCertificatesToReissue now lives in _lib/Installer.Ui.psm1
# (imported above) — shared with Repair-OrphanedCertificates.ps1, which
# reuses the exact same logic for one-off repair runs.
