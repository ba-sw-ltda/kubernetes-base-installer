...
.SYNOPSIS
    ...
    Platform-specific vault provider is installed by the vault backend component (23-*).
.PARAMETER Platform
    Target platform
...
Write-Host "  Installing: 22 - Secrets Store CSI Driver" -ForegroundColor Cyan
Write-Host "========================================`n" -ForegroundColor Cyan
...
Write-Host "  Vault provider is installed by the 23-* component." -ForegroundColor Gray
Write-Host "  ──────────────────────────────────────────" -ForegroundColor DarkGray
